...
export const PageTitle:FC<IPageTitleProps> = ( {title}) => {
    ...
    return (
        <>
            ...
            <div>
                <div className="absolute top-0 z-0 left-0 w-full h-screen">
                    <div
                        className="bg-title-bg-light dark:bg-title-bg-dark opacity-30 rounded-b-full h-full w-full transform -translate-y-1/2 -z-10" />
                </div>
            </div>
        </>
    )
